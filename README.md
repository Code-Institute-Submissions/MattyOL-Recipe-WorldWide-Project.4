...
* Home-Page 
  * The Landing page consists of a Nav-Bar that displays a Home-page About-page, Signup-page , Login.  A search-bar and also displays 6 Recipe posts which also the user can click next to navigate onto the rest of the blog posts on the next page. 
  <img width="970" alt="Screen Shot 2023-05-16 at 13 19 22" src="https://github.com/MattyOL/Recipe-WorldWide-Project.4/assets/111317260/17e4e7a5-545b-4a15-a3cf-c2984eadea6c">
![Screen Shot 2023-05-16 at 13 19 33](https://github.com/MattyOL/Recipe-WorldWide-Project.4/assets/111317260/991534f7-31af-4029-ad69-27af54a7fc88)
...
* Alerts 
  There is an alert when you sign in logout , add recipe , edit recipe , delete recipe to let the user know what they have done has been completed. 
* logged in
...
## Testing 
For all testing, please refer to the [Testing.md](https://github.com/MattyOL/Recipe-WorldWide-Project.4/blob/main/Testing.md) file.
